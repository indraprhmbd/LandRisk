...
export interface InterpretationOutput {
  ...
  limitations: string;
  is_ai_generated?: boolean; // Flag to indicate if AI was used
}
...
export async function getInterpretation(
  ...
  const aiBaseUrl = process.env.AI_ENDPOINT_URL || "http://127.0.0.1:7860";
  ...
  return {
    ...generateFallbackInterpretation(request),
...
function generateFallbackInterpretation(
  ...
  const limitations = [
    "⚙️ Interpretation generated by LandRisk Deterministic Engine (AI service unavailable).",
    low_integrity
      ? "⚠️ Data completeness is below acceptable threshold (60%). Findings are preliminary and require field verification."
      : "",
