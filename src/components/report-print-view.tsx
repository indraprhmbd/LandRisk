...
export default function ReportPrintView({ data, onClose }: PrintViewProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 print:static print:bg-white">
      <div className="absolute inset-0 overflow-auto print:static">
        {/* Print Button - Hidden in Print */}
        <div className="sticky top-0 z-10 flex justify-between items-center p-4 bg-surface-dark border-b border-surface-border print:hidden">
          <h2 className="text-white font-bold">Print Preview</h2>
